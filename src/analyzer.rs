...
use swc_common::{self, FileName, errors::{Handler, HandlerFlags, Diagnostic, DiagnosticBuilder}, SourceMap, comments::Comments, Span, Globals};
use swc_ecma_parser::{Parser, JscTarget, Session, Syntax, lexer::Lexer, SourceFileInput, TsConfig};
use swc_ecma_ast::{NamedExport, ImportDecl, ExportAll, CallExpr};
